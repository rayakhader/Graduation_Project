...
function SideBarOwner() {
  const drawerItems = useMemo(() =>[{text:'Dashboard',Icon:DashboardIcon,path:'/dashboard'}, {text:'Apartments',Icon:ApartmentIcon,path:'/dashboard/apartments'},{text:'Discounts',Icon:LocalOfferIcon,path:'/dashboard/discounts'},{text:'Tenants',Icon:GroupIcon,path:'/dashboard/tenants'},{text:'Contracts',Icon:ArticleIcon,path:'/dashboard/contracts'},
 {text:'Following',Icon:FollowTheSignsIcon,path:'/dashboard/following'},{text:'Followers',Icon:PeopleAltIcon,path:'/dashboard/followers' }
    ...
    useEffect(() => {
      ...
      if(currentPath==='/dashboard/apartments/add-apartment'){
        setSelectedItem('Apartments')
      }else {
...
: darkMode
  ...
  : '#000' 
   ...
   {!isXsOrSmOrMd && <IconButton onClick={handleToggleDrawer}  sx={{backgroundColor:'primary.main',color:'white',':hover':{backgroundColor:'primary.main'}}} >
